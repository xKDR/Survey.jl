...
% Title and author information (moved from header.tex)
...
\author[4]{Iulia Dumitru}
\affil[1]{XKDR Forum}
\affil[2]{Simon Fraser University}
\affil[3]{Chennai Mathematical Institute}
\affil[4]{Politehnica University of Bucharest}

\hypersetup{
pdftitle = {Survey.jl - An Efficient Framework for Analysing Complex Surveys},
pdfsubject = {JuliaCon 2022 Proceedings},
pdfauthor = {Ayush Patnaik, Nadia Enhaili, Siddhant Chaudhary, Shikhar Mishra, Iulia Dumitru},
...
% Bibliography using ref.bib
\bibliographystyle{plain}
\bibliography{ref}

\begin{center}
        \textbf{\textit{This paper is currently under review for JuliaCon 2022 Proceedings.}}
\end{center}
